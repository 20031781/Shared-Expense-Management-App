...
export const translations = {
    en: {
        ...
        expenses: {
            ...
            dateHelper: 'Use the YYYY-MM-DD format to backdate the payment.',
            dateToday: 'Today',
    ...
    it: {
        ...
        expenses: {
            ...
            dateHelper: 'Inserisci la data nel formato AAAA-MM-GG.',
            dateToday: 'Oggi',
            dateYesterday: 'Ieri',
            invalidDate: 'Inserisci una data valida (AAAA-MM-GG).',
