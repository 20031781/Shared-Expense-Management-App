...
export const translations = {
    en: {
        ...
        lists: {
            ...
            splitSettlement: ({from, to, amount}: {from: string; to: string; amount: string}) => `${from} → ${to}: ${amount}`,
        ...
        members: {
            ...
            autoBalanceHint: ({remaining, recipients, share}: {remaining: number; recipients: number; share: number}) => `The remaining ${remaining.toFixed(2)}% will be split evenly (${share.toFixed(2)}%) across ${recipients} other members.`,
            ...
            statusLegend: '🟢 Active · 🟡 Pending – the member has not accepted the invite yet.',
        ...
        settings: {
            ...
            logoutSecondary: 'Switch account',
            switchTitle: 'Switch account?',
            switchDescription: 'Sign out and return to the login screen to use another profile.',
            switchConfirm: 'Switch account',
            switchInfo: 'Use this shortcut when you need to log in with another email.',
        ...
        analytics: {
            ...
            listPickerDropdownPlaceholder: 'Pick a list to analyze',
    ...
    it: {
        ...
        members: {
            ...
            autoBalanceHint: ({remaining, recipients, share}: {remaining: number; recipients: number; share: number}) => `Il ${remaining.toFixed(2)}% rimanente verrà diviso in parti uguali (${share.toFixed(2)}%) tra ${recipients} altri membri.`,
            ...
            statusLegend: '🟢 Attivo · 🟡 In attesa: il membro non ha ancora accettato l’invito.',
        ...
        settings: {
            ...
            logoutButton: 'Esci',
            logoutSecondary: 'Cambia account',
            switchTitle: 'Cambiare account?',
            switchDescription: 'Ti disconnetterai e tornerai alla schermata di accesso per usare un altro profilo.',
            switchConfirm: 'Cambia account',
            switchInfo: 'Usa questa opzione se devi accedere con un’altra email.',
            logoutConfirm: 'Esci',
        },
        auth: {
            title: 'Split Expenses',
        ...
        analytics: {
            ...
            listPickerDropdownPlaceholder: 'Scegli una lista da analizzare',
