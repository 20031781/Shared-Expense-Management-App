...
export const translations = {
    en: {
        ...
        lists: {
            ...
            renameDescription: 'Update the list name to keep things organised.',
            renameSubmit: 'Save name',
            updateSuccess: 'List updated successfully',
            updateError: 'Unable to update the list. Please try again.',
        ...
        expenses: {
            ...
            splitOverrideTitle: 'Split preferences',
            splitOverrideHelper: 'Override the default member percentages for this expense.',
            splitManual: 'Amounts',
            splitShares: 'Shares',
            splitPreview: 'Allocated so far: {{amount}}',
            splitTotalMismatch: 'The sum of amounts ({{current}}) does not match the total ({{total}}).',
            splitSharesMissing: 'Add at least one share to distribute the expense.',
        ...
        analytics: {
            ...
            chartSpeedTitle: 'Animation speed',
            chartSpeedHelper: 'Pick how lively the chart transitions should feel.',
            chartSpeedFast: 'Fast',
            chartSpeedMedium: 'Medium',
            chartSpeedSlow: 'Slow',
            memberTrendEmpty: 'We need a few expenses to plot the trend for this list.',
            chartFallback: 'We could not render these charts. Retry after refreshing the data.',
        },
        notifications: {},
    },
    it: {
        ...
        lists: {
            ...
            renameDescription: 'Aggiorna il nome per mantenere ordine e chiarezza.',
            renameSubmit: 'Salva nome',
            updateSuccess: 'Lista aggiornata con successo',
            updateError: 'Impossibile aggiornare la lista. Riprova.',
        ...
        expenses: {
            ...
            splitOverrideTitle: 'Divisione personalizzata',
            splitOverrideHelper: 'Sovrascrivi le percentuali dei membri solo per questa spesa.',
            splitManual: 'Importi',
            splitShares: 'Parti',
            splitPreview: 'Ripartizione calcolata: {{amount}}',
            splitTotalMismatch: 'La somma degli importi ({{current}}) non coincide con il totale ({{total}}).',
            splitSharesMissing: 'Aggiungi almeno una parte per ripartire la spesa.',
        ...
        analytics: {
            ...
            chartModePie: 'Torta',
            chartModeTrend: 'Trend',
            chartSpeedTitle: 'Velocità animazione',
            chartSpeedHelper: 'Scegli quanto rapide devono essere le transizioni dei grafici.',
            chartSpeedFast: 'Veloce',
            chartSpeedMedium: 'Media',
            chartSpeedSlow: 'Lenta',
            memberTrendEmpty: 'Servono più spese per disegnare questo grafico.',
            chartFallback: 'Impossibile disegnare i grafici. Aggiorna per riprovare.',
        },
        notifications: {},
    },
};
